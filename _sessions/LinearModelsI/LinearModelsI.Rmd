...
ggplot(d, 
  ...
  geom_point() +
  annotate("text", x = mean(d$Äquivalenzeinkommen, na.rm=T) + 900, y = 10, label = "bar(x)", parse = TRUE, size = 5) +
  annotate("text", y = mean(d$Nächte, na.rm = T) + 600, x = 5000, label = "bar(y)", parse = TRUE, size = 5) +
  theme_bw()
...
<h1><a href="https://therbootcamp.github.io/SmR_2022Apr/_sessions/LinearModelsI/LinearModelsI_practical.html">Practical</a></h1>
